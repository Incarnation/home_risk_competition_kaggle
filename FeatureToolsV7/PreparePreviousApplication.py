...
class PreparePreviousApplication(object):
    ...
    def data_transform(self):
        ...
        self.__previous_application = cu.replace_day_outliers(self.__previous_application)
        self.__previous_application = self.__previous_application.replace(['XNA', 'XAP'], np.nan)
        ...
        #print("data transform for previous application done:")
