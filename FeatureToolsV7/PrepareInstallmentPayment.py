...
class PrepareInstallmentPayment(object):
    ...
    def data_prepare(self):
        self.__installment_payment = pd.read_csv(os.path.join(self.__input_path, "installments_payments.csv"))
        self.__installment_payment = self.__installment_payment.drop(["SK_ID_CURR"], axis=1)

    def data_transform(self):
        self.__installment_payment = cu.replace_day_outliers(self.__installment_payment)
