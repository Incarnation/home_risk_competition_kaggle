...
class PrepareApplicationTrain(object):
    ...
    def data_transform(self):
        self.__application_train = cu.replace_day_outliers(self.__application_train)
        ...
        self.__application_train = self.__application_train[self.__application_train['CODE_GENDER']!='XNA']
        self.__application_train = self.__application_train.drop(dropcolum, axis=1)

        # Categorical features with Binary encode (0 or 1; two categories)
        for bin_feature in ['CODE_GENDER', 'FLAG_OWN_CAR', 'FLAG_OWN_REALTY']:
            self.__application_train[bin_feature], uniques = pd.factorize(self.__application_train[bin_feature])
    ...
    def data_return(self):
        #print(self.__application_train.head())
        self.__application_train.to_csv(os.path.join(self.__input_path, "application_train_temp.csv"), index=False)
