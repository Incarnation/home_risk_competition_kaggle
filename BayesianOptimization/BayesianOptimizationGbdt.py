...
class BayesianOptimizationGbdt(object):
    ...
    def data_prepare(self):
        self.__train = pd.read_csv(os.path.join(self.__input_path, "train_matrix_aug18.csv"))
    ...
    def parameter_tuning(self):
        ...
        print(self.__gbm_bo.res['max']['max_params'])


if __name__ == "__main__":
    botp = BayesianOptimizationGbdt(
        input_path=r"C:\Users\huang\Desktop\home-credit-default-risk-feature-tools"
    )
    botp.data_prepare()
